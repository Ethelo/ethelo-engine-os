...
namespace ethelo
{
    ...
    public:
        ...
        bool is_detail_excluded(const std::string detail_name) const;
        ...
        size_t original_option_index(const size_t active_index) const { return options_in_scope_.empty() ? active_index : original_option_indexes_[active_index]; }
